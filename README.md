...
画像・映像・音楽・小説・3D・絵画・アニメーションの制作に特化したAI創作アプリを紹介・提供するための、完全無料で運用できるホームページです。
...
| **Quill** | AI小説作成 | AIプロットジェネレーターと文章解析で物語を書き上げる |
| **Mesh** | AI 3D作成 | プリミティブ編集とAIレイアウトでシーンを組み立てる（WebGL） |
| **Fleur** | AI絵画作成 | 万華鏡シンメトリーとAI下絵ジェネレーターで描く |
| **Anima** | AIアニメーション作成 | オニオンスキンとAIフレーム一括生成でコマ撮りアニメーションを作る |
...
│   ├── flux/                   # AI映像編集アプリ「Flux」
│   ├── echo/                   # AI音楽編集アプリ「Echo」
│   ├── quill/                  # AI小説作成アプリ「Quill」
│   ├── mesh/                   # AI 3D作成アプリ「Mesh」
│   ├── fleur/                  # AI絵画作成アプリ「Fleur」
│   ├── anima/                  # AIアニメーション作成アプリ「Anima」
